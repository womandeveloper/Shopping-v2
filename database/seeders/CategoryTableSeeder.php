...
class CategoryTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('category')->insert(['category_name'=>'TV ve Ses Sistemleri','slug'=>'tv-ses-sistemleri','parent_id'=>$id]);
        DB::table('category')->insert(['category_name'=>'Kamera','slug'=>'kamera','parent_id'=>$id]);
        $id = DB::table('category')->insertGetId(['category_name'=>'Kitap','slug'=>'kitap']);
        DB::table('category')->insert(['category_name'=>'Edebiyat', 'slug'=>'edebiyat', 'parent_id'=>$id]);
        DB::table('category')->insert(['category_name'=>'Çocuk', 'slug'=>'cocuk', 'parent_id'=>$id]);
        DB::table('category')->insert(['category_name'=>'Bilgisayar', 'slug'=>'bilgisayar', 'parent_id'=>$id]);
        DB::table('category')->insert(['category_name'=>'Sınavlara Hazırlık', 'slug'=>'sinavlara-hazirlik', 'parent_id'=>$id]);
